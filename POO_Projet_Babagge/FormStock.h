...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &FormStock::Cherche);
			// 
			// button2
			// 
...
#pragma endregion
	private: System::Void FormStock_Load(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		this->oDs = this->oSvcSt->SelectionnerTousLeStock("Rsl");
		this->dataGridView1->DataSource = this->oDs;
		this->dataGridView1->DataMember = "Rsl";
	}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) 
{
	FormSuppStock = gcnew POO_Projet_Babagge::FormSupprStock;
	FormSuppStock->Show();
}
private: System::Void Cherche(System::Object^ sender, System::EventArgs^ e) 
{
